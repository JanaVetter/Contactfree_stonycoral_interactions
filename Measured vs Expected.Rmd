...
```{r}
#((100/ exp)* net_obs) -100, rewritten it is ((net_obs/exp)*100)-100, is the same as ((net_obs/exp)-1)*100, is the same as ((net_obs-exp)/exp)*100 as exp cut out(rauskürzen)
...
# Net photo
con_net_graph <-ggplot(con_net, aes(x =species, y = exp_obs_net_photo_perc, fill = type)) +
  ...
  scale_fill_manual(name = "", labels = c("neg" = "significantly negative", "neutral" = "no significant difference", "pos" = "significantly positive"), values = c("neg"="#FF9999","neutral"= "#CCCCCC", "pos" = "#c4eda1"))+
  scale_y_continuous(limits = c(-70, 120), breaks = seq(-80, 120, by = 40))+
  annotate("text", x= 1, y = 90, label = "***", size= 8 )+
  annotate("text", x= 2, y = 90, label = "***", size= 8)+
  annotate("text", x= 3, y = 90, label = "**", size= 8)+
  annotate("text", x= 6, y = 90, label = "**", size= 8 )+
  annotate("text", x= 2, y = -70, label = "Poritidae", size= 4, fontface="bold" )+
  annotate("text", x= 5, y = -70, label = "Acroporidae", size= 4, fontface="bold" )+
  annotate("text", x= 8, y = -70, label = "Pocilloporidae", size= 4, fontface="bold" )+
  geom_vline(xintercept = 3.5, linetype = 3, color="black")+
  geom_vline(xintercept = 6.5, linetype = 3, color="black")+
  theme

# respiration
con_resp_graph <-ggplot(con_resp, aes(x = species, y = exp_obs_respiration_perc, fill=type)) +
  geom_boxplot(outlier.shape = NA, lwd=1) +
  geom_jitter(inherit.aes = TRUE, position=position_jitterdodge(dodge.width=0.2, jitter.width=0.2), size = 1) +
  geom_hline(yintercept = 0, linetype = 2, color = "black") +
  ylab("\nRespiration\n(% change from expected)") +
  scale_fill_manual(name = "", labels = c("neg" = "significantly negative", "neutral" = "no significant difference", "pos" = "significantly positive"), values = c("neg"="#FF9999","neutral"= "#CCCCCC", "pos" = "#c4eda1"))+
  scale_y_continuous(limits = c(-100, 200), breaks = seq(-80, 160, by = 40))+
  annotate("text", x= 2, y = 140, label = "*", size= 8 )+
  annotate("text", x= 4, y = 140, label = "*", size= 8 )+
  annotate("text", x= 7, y = 140, label = "*", size= 8 )+
  annotate("text", x= 2, y = -100, label = "Poritidae", size= 4, fontface="bold" )+
  annotate("text", x= 5, y = -100, label = "Acroporidae", size= 4, fontface="bold" )+
  annotate("text", x= 8, y = -100, label = "Pocilloporidae", size= 4, fontface ="bold" )+
  geom_vline(xintercept = 3.5, linetype = 3, color="black")+
  geom_vline(xintercept = 6.5, linetype = 3, color="black")+
  theme

# gross photo
con_gross_graph <-ggplot(con_gross, aes(x = species, y =exp_obs_gross_photo_perc, fill =type)) +
  geom_boxplot(outlier.shape = NA, lwd=1) +
  geom_jitter(inherit.aes = TRUE, position=position_jitterdodge(dodge.width=0.2, jitter.width=0.2), size = 1) +
  geom_hline(yintercept = 0, linetype = 2, color = "black") +
  ylab("\nGross photosynthesis\n(% change from expected)") +
  scale_fill_manual(name = "", labels = c("neg" = "significantly negative", "neutral" = "no significant difference", "pos" = "significantly positive"), values = c("neg"="#FF9999","neutral"= "#CCCCCC", "pos" = "#c4eda1"))+
  scale_y_continuous(limits = c(-55, 100), breaks = seq(-40, 80, by = 40))+
  annotate("text", x= 1, y = 99, label = "**", size= 8 )+
  annotate("text", x= 2, y = 99, label = "*", size= 8 )+
  annotate("text", x= 5, y = 99, label = "*", size= 8 )+
  annotate("text", x= 6, y = 99, label = "**", size= 8 )+
  annotate("text", x= 7, y = 99, label = "**", size= 8 )+
  annotate("text", x= 2, y = -55, label = "Poritidae", size= 4, fontface="bold" )+
  annotate("text", x= 5, y = -55, label = "Acroporidae", size= 4, fontface="bold" )+
  annotate("text", x= 8, y = -55, label = "Pocilloporidae", size= 4, fontface="bold" )+
  geom_vline(xintercept = 3.5, linetype = 3, color="black")+
  geom_vline(xintercept = 6.5, linetype = 3, color="black")+
  theme
```
...
# net photo
div_net_graph <- ggplot(mix_net, aes(x = reorder(species, exp_obs_net_photo_perc, median), y = exp_obs_net_photo_perc, fill = type_2)) +
  geom_boxplot(outlier.shape = NA, lwd=1) +
  geom_jitter(inherit.aes = TRUE, position=position_jitterdodge(dodge.width=0.2, jitter.width=0.2), size = 1) +
  geom_hline(yintercept = 0, linetype = 2, color = "black") +
  ylab("\nNet photosynthesis\n(% change from expected)") +
  ...
  annotate("text", x= 1, y = 80, label = "**", size= 8 )+
  annotate("text", x= 2, y = 80, label = "**", size= 8)+
  annotate("text", x= 3, y = 80, label = "**", size= 8)+
  annotate("text", x= 11, y = 80, label = "*", size= 8 )+
  ...
  coord_cartesian(ylim= c(-50, 80), xlim = c(1,12), clip = "off")+
  theme


# respiration
div_resp_graph <-ggplot(mix_resp, aes(x = species, y = exp_obs_respiration_perc, fill=type_2)) +
  geom_boxplot(outlier.shape = NA, lwd=1) +
  geom_jitter(inherit.aes = TRUE, position=position_jitterdodge(dodge.width=0.2, jitter.width=0.2), size = 1) +
  geom_hline(yintercept = 0, linetype = 2, color = "black") +
  ylab("\nRespiration\n(% change from expected)") +
  scale_fill_manual(name = "", labels = c("neg" = "significantly negative", "neutral" = "no significant difference", "pos" = "significantly positive"), values = c("neg"="#FF9999","neutral"= "#CCCCCC", "pos" = "#c4eda1"))+
  scale_y_continuous(breaks = seq(-40, 80 , by = 40))+
  annotate("text", x= 4, y = 80, label = "*", size= 8 )+
  annotate("text", x= 7, y = 80, label = "**", size= 8 )+
  annotate("text", x= 9, y = 80, label = "*", size= 8 )+
  annotate("text", x= 10, y = 80, label = "*", size= 8 )+
  annotate("text", x= -0.8, y = -67, label = "Poritidae", size=4, fontface= "bold")+
  annotate("text", x= -1.9, y = -82, label = "Acroporidae", size=4, fontface= "bold")+
  annotate("text", x= -3, y = -97, label = "Pocilloporidae", size=4, fontface= "bold")+
  coord_cartesian(ylim= c(-50, 80), xlim = c(1,12), clip = "off")+
...
# gross photo
div_gross_graph <-ggplot(mix_gross, aes(x = species, y =exp_obs_gross_photo_perc, fill =type_2)) +
  geom_boxplot(outlier.shape = NA, lwd=1) +
  geom_jitter(inherit.aes = TRUE, position=position_jitterdodge(dodge.width=0.2, jitter.width=0.2), size = 1) +
  geom_hline(yintercept = 0, linetype = 2, color = "black") +
  ylab("\nGross photosynthesis\n(% change from expected)") +
  ...
  annotate("text", x= 1, y = 40, label = "*", size= 8 )+
  annotate("text", x= 2, y = 40, label = "**", size= 8 )+
  annotate("text", x= 4, y = 40, label = "*", size= 8 )+
  annotate("text", x= 7, y = 40, label = "*", size= 8 )+
  annotate("text", x= 10, y = 40, label = "*", size= 8 )+
  annotate("text", x= -0.8, y = -52, label = "Poritidae", size=4, fontface= "bold")+
  annotate("text", x= -1.9, y = -62, label = "Acroporidae", size=4, fontface= "bold")+
  annotate("text", x= -3, y = -72, label = "Pocilloporidae", size=4, fontface= "bold")+
  coord_cartesian(ylim= c(-40, 50), xlim = c(1,12), clip = "off")+
  theme


# calcification
div_calc_graph <-ggplot(mix_calc, aes(x = species, y = exp_obs_calc_perc, fill =type_2)) +
  geom_boxplot(outlier.shape = NA, lwd=1) +
   geom_jitter(inherit.aes = TRUE, position=position_jitterdodge(dodge.width=0.2, jitter.width=0.2), size = 1) +
  geom_hline(yintercept = 0, linetype = 2, color = "black") +
  ylab("\nCalcification\n(% change from expected)") +
...
arranged_perc_conmix <- ggarrange(
          con_net_graph, div_net_graph, con_resp_graph, div_resp_graph, con_gross_graph,  div_gross_graph,
...
ggsave("Graphs/All_mixANDcon_perc.png", width=12, height= 13, limitsize=FALSE, dpi= 700, arranged_perc_conmix)
```
...
con_lolli <-ggplot(final_median, aes(x= species, y=median, color=name))+
  ...
  scale_y_continuous(limits = c(-34, 65), breaks = seq(-20, 60, by = 20))+
  ylab("Productivity with conspecifics\n(medians)")+
  ...
  annotate("text", x= 2, y = -34, label = "Poritidae", size= 3, fontface="bold" )+
  annotate("text", x= 5, y = -34, label = "Acroporidae", size= 3, fontface="bold" )+
  annotate("text", x= 8, y = -34, label = "Pocilloporidae", size= 3, fontface="bold" )+
  geom_vline(xintercept = 3.5, linetype = 3, color="black")+
  geom_vline(xintercept = 6.5, linetype = 3, color="black")+
  theme_lolli
```
...
div_lolli <-  ggplot(final_summedian_mix, aes(x = species, y = value, color=name)) +
    geom_hline(yintercept = 0, linetype = 2, color = "black") +
    geom_linerange(aes(x = species, ymin = value, ymax = 0), position = position_dodge(width = 0.5)) +
    geom_point(position = position_dodge(width = 0.5), size = 3, shape = 18)+
    ylab("Productivity with diversity\n(\U03A3\ of medians)")+
    scale_color_manual("", values= c("median_sum_gross_mix" ="#C81ACC","median_sum_net_mix" = "#F16226", "median_sum_resp_mix"= "#44AA99"),labels = c("median_sum_gross_mix" = "gross photosynthesis", "median_sum_net_mix" = "net photosynthesis", "median_sum_resp_mix" = "respiration"))+
    ...
    annotate("text", x= 2, y = -63, label = "Poritidae", size= 3, fontface="bold" )+
    annotate("text", x= 5, y = -63, label = "Acroporidae", size= 3, fontface="bold" )+
    annotate("text", x= 8, y = -63, label = "Pocilloporidae", size= 3, fontface="bold" )+
    geom_vline(xintercept = 3.5, linetype = 3, color="black")+
    geom_vline(xintercept = 6.5, linetype = 3, color="black")+
    theme_lolli
```
...
arranged_condiv_lolli <- ggarrange(
          con_lolli, div_lolli, 
          labels = c("a)", "b)"),
          label.x = 0.132,
          label.y = 0.92,
...
ggsave("Graphs/con_div_median_expob_lolli.png", width=7, height=6, limitsize=FALSE, dpi= 700, arranged_condiv_lolli)
```
